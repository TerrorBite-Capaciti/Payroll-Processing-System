...
FILE-CONTROL.
    SELECT EMPLOYEE-FILE ASSIGN TO 'employee.cbl'
       ORGANIZATION IS INDEXED
       ACCESS MODE IS RANDOM
       RECORD KEY IS EMPLOYEE-ID.
    SELECT PAYSLIP-FILE ASSIGN TO 'payslip_generator.cbl'
...
CALCULATE-SALARY.
    COMPUTE WS-TOTAL-SALARY = HOURS-WORKED * HOURLY-RATE.
    COMPUTE WS-OVERTIME-PAY = OVERTIME-HOURS * OVERTIME-RATE.
    COMPUTE WS-GROSS-SALARY = WS-TOTAL-SALARY + WS-OVERTIME-PAY.
